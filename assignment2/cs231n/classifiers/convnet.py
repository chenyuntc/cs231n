...
class ConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        W2 = np.random.randn(H*W*F/4,hidden_dim)*weight_scale
        ...
        ],self.params['W3'],self.params['b3']=W1,b1,W2,b2,W3,b3
    ...
    def loss(self, X, y=None):
        ...
        z2,cache2=conv_relu_pool_forward(X, W2,b2,conv_param,pool_param)
